...
<div class="container pb-6 pt-6">
	...
	<form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/usuarioAjax.php" method="POST" autocomplete="off" >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Nombre/s <?php echo CAMPO_OBLIGATORIO; ?></label>
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Apellido/s <?php echo CAMPO_OBLIGATORIO; ?></label>
		...
		<br><br>
		<h1 style="font-weight: bold; font-size: 22px; margin-bottom: 15px;">ACTUALIZAR CONTRASEÑA</h1>
		<p class="has-text-centered">
			Para actualizar la contraseña de su cuenta, debera ingresar los campos solicitados, en caso de no desearlo, dejarlos vacios.
		</p>
		<br>
		<div class="columns">
		  	<div class="column">
		...
		<br><br><br>
		<h1 style="font-weight: bold; font-size: 22px; margin-bottom: 15px;">ACTUALIZAR DATOS</h1>
		<p class="has-text-centered">
			Para poder actualizar los datos de este usuario por favor ingrese su USUARIO y CONTRASEÑA actuales
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Usuario <?php echo CAMPO_OBLIGATORIO; ?></label>
